...
describe AnyGood::MovieFetcher do
  describe '.fetch_by_name_and_year' do
    before(:each) do
      @rating = {score: 8.0, url: 'www.one.com'}
    ...
    it 'returns an movie object with the right attributes' do
      ...
      movie.ratings['rating_client'][:url].should == 'www.one.com'
      movie.ratings['rating_client'][:score].should eq(8.0)
    ...
    context 'cache is empty' do
      ...
      it 'fetches ratings from all rating clients' do
        second_rating_client_rating = {score: 4.0, url: 'www.two.com'}
